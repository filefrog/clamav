...
1. Ensure that the Docker image still builds, can be deployed to a
   modern version of Docker / Kubernetes (preferably still under
   support from upstream), and that it properly detects viruses.
